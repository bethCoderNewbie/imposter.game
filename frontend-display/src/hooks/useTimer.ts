...
/** Derives a countdown from server's timer_ends_at timestamp.
 *  Uses requestAnimationFrame per PRD-003 §7 anti-pattern #5:
 *  never use setInterval as the authoritative countdown source. */
